...
(() => {
  const base = '_ds/chipsa-lander-design-system-d7234785-1645-41cd-b5dd-ea1bcfbbe23d';
  ...
  // Scroll-reveal runtime (drives .reveal / [data-reveal] via base.css).
  const r = document.createElement('script');
  r.src = base + '/reveal.js';
